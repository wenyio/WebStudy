...
<%@ page import="com.example.shopping.valuebean.GoodsSingle" %>
<!-- 通过动作标识，获取ShopCar类实例 -->
<jsp:useBean id="myCar" class="com.example.shopping.toolbean.ShopCar" scope="session"/>
<%
...
<table border="1" width="450" rules="none" cellspacing="0" cellpadding="0">
	...
	<tr align="center" height="50">
		...
		<td><%=money%></td>
		<td>
<a href="docar.jsp?action=remove&name=<%=single.getName() %>&date=<%=System.currentTimeMillis()%>">移除</a>
</td>
	</tr>
	<%
			}
